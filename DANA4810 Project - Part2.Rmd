...
#### 4.3 How to restore from a Local Changes (Before Commit)
...
```{r, echo=FALSE, out.width="80%", fig.align="left"}
knitr::include_graphics("43_Revert.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="left"}
knitr::include_graphics("47_Branch.png")
```
...
knitr::include_graphics("47_Branch2.png")
```
